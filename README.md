...
>你好，我是成名，[《重学Java设计模式》](https://item.jd.com/13218336.html) 图书作者，一线互联网 Java 工程师、架构师。

## 博客搭建

有粉丝伙伴问成名，你那博客：[http://blogs.xin-x.club](http://blogs.xin-x.club) 挺好的我也想整一个，面试写到简历上`还能加分`，也是给自己建设影响力的东西。
...
接下来成名就教你构建这样一个博客，因为我已经帮你准备好了博客模板，所以在这个过程中，你只要跟着步骤，点点点，就部署完事了。**那整吧**，`咱们走起`！
...
<br/>
<div align="center">
    <a href="https://github.com/fuzhengwei/CodeGuide">关注成名，你可以学到的更多！</a>
</div>
<br/>  
...
- **加群交流**
    ...
    <img src="./docs/assets/img/asm-doc/cm-qr-code.jpg" width="180" height="180"/>
